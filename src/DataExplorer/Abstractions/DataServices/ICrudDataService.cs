...
/// </summary>
[PublicAPI]
public interface ICrudDataServiceBase<TEntity, TId, out TContext> : IReadOnlyDataServiceBase<TEntity, TId, TContext>
    ...
    where TId : IComparable, IEquatable<TId>, IComparable<TId>
{
    ...
    /// </summary>
    IRepositoryBase<TEntity,TId> Repository { get; }
    ...
    /// <param name="shouldSwapAttached">Whether to swap existing entity with same primary keys attached to current <see cref="IDataContextBase"/> with new one </param>
    ...
    /// <param name="shouldSwapAttached">Whether to swap existing entities with same primary keys attached to current <see cref="IDataContextBase"/> with new ones </param>
    /// <returns><see cref="Result"/> of the operation</returns>
    ...
    ///         <see cref="IDataContextBase.SaveChangesAsync" /> is called. It also does not interact with the EF change tracker in any way:
    ...
    /// <summary>
    ///     <para>
    ///         Detaches the given entry from the current context, such that changes applied to it will not be reflected in the database when <see cref="IDataContextBase.SaveChangesAsync"/> is called.
    ///     </para>
    /// </summary>
...
/// </summary>
[PublicAPI]
public interface ICrudDataServiceBase<TEntity, out TContext> : ICrudDataServiceBase<TEntity, long, TContext>, IReadOnlyDataServiceBase<TEntity, TContext>
