...
namespace DataExplorer.Specifications.Expressions;
...
{
    /// <summary>
    /// If <see cref="Type" /> is <see cref="IncludeType.Include" />, represents a related entity that should be included.<para />
    /// If <see cref="Type" /> is <see cref="IncludeType.ThenInclude" />, represents a related entity that should be included as part of the previously included entity.
    /// </summary>
