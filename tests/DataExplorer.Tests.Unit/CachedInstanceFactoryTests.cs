...
[Collection("CachedInstanceFactoryTests")]
public class CachedInstanceFactoryTests
{
    private static ConcurrentDictionary<Type, CreateDelegate> GetCachedFuncs<TArg1,TArg2,TArg3,TArg4>(CachedInstanceFactory factory)
    ...
    {
        [Fact]
        public void ShouldUseCachedCtorDelegateWhenCalledTwiceNoArgCtor()
        {
            // Arrange
        ...
        [Fact]
        public void UseCachedCtorDelegateWhenCalledTwice1ArgCtor()
        {
            // Arrange
            var factory = new CachedInstanceFactory();
        ...
        [Fact]
        public void UseCachedCtorDelegateWhenCalledTwice2ArgCtor()
        {
            // Arrange
            var factory = new CachedInstanceFactory();
        ...
        [Fact]
        public void UseCachedCtorDelegateWhenCalledTwice3ArgCtor()
        {
            // Arrange
            var factory = new CachedInstanceFactory();
        ...
        [Fact]
        public void UseCachedCtorDelegateWhenCalledTwice4ArgCtor()
        {
            // Arrange
            var factory = new CachedInstanceFactory();
            ...
            st1.Start();
            var instance1 = factory.CreateInstance(type, "test", 1, new Test2("test", 1),
                new Test3("test", 1, new Test2("test", 1)));
            st1.Stop();
            st2.Start();
            var instance2 = factory.CreateInstance(type, "test1", 2, new Test2("test", 1),
                new Test3("test", 1, new Test2("test", 1)));
        ...
        [Fact]
        public void RetainTwoCachedDelegates()
        {
            // Arrange
            var factory = new CachedInstanceFactory();
