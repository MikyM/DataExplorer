...
[PublicAPI]
public abstract class AuditableEfDbContext : EfDbContext, IAuditableEfDbContext
{
    /// <summary>
    ...
    /// <inheritdoc />
    protected AuditableEfDbContext(DbContextOptions options) : base(options)
    {
    }

    /// <inheritdoc />
    protected AuditableEfDbContext(DbContextOptions options, IOptions<DataExplorerEfCoreConfiguration> config) : base(options)
    {
    }
