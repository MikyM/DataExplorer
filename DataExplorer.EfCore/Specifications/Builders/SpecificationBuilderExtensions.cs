...
public static class SpecificationBuilderExtensions
{
    ...
    public static IUpdateSpecificationBuilder<T> Update<T>(this IUpdateSpecificationBuilder<T> specificationBuilder,
        Expression<Func<SetPropertyCalls<T>, SetPropertyCalls<T>>> setPropertyCalls) where T : class =>
        Update(specificationBuilder, setPropertyCalls, true);
