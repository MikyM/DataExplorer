...
public class UpdateSpecification<T> : BasicSpecification<T>, IUpdateSpecification<T> where T : class
{
    ...
    public UpdateSpecification<T> Update(Expression<Func<SetPropertyCalls<T>, SetPropertyCalls<T>>> setPropertyCalls)
    {
        Query.Update(setPropertyCalls);
        return this;
    }
    ...
    public UpdateSpecification<T> Update(Expression<Func<SetPropertyCalls<T>, SetPropertyCalls<T>>> setPropertyCalls, bool condition)
    {
        Query.Update(setPropertyCalls, condition);
        return this;
    }
}
